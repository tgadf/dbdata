...
setup(
  name = 'dbdata',
  py_modules = ['artistDBBase', 'artistIDBase', 'dbArtistsBase', 'dbBase', 'dbUtils', 'dbArtistsID', 
                "dbArtistsMetadata", 'dbArtistsParse', 'dbArtistsParseExtra', 'dbArtistsParseCredit', 
                'dbArtistsParseSong', 'dbArtistsParseComposition', 'dbArtistsParseUnofficial',
                'artistModValue',
                ...
                'artistDeezerAPI', 'dbArtistsDeezerAPI', 
                'artistLastFM', 'dbArtistsLastFM', 
                'artistLastFMAPI', 'dbArtistsLastFMAPI', 
                ...
                'artistSpotifyCharts', 'dbArtistsSpotifyCharts',
                'artistSpotify', 'dbArtistsSpotify',
                'artistSoundcloud', 'dbArtistsSoundcloud',
                'artistTidal', 'dbArtistsTidal'],
  version = '0.0.1',
